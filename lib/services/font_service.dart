...
class FontService {
  ...
  static Future<bool> isFontAvailable() async {
    try {
      ...
      // It doesn't strictly guarantee it renders, but it's the best proxy we have for "Is it setup?".
      await rootBundle.load('assets/fonts/NotoSerifEthiopic-Regular.ttf');
      // If we don't throw, it's likely accessible in assets.
      return true;
    } catch (e) {
